...
import type { Citation, CorpusVersion } from '@/components/shared/versions'
import { VERSION_LABEL } from '@/components/shared/versions'
...
import { closestPoint, type Landing } from '@/lib/corpus/closest-point'
import { eurLexUrl } from '@/lib/corpus/eur-lex'
 ...
 * opens on the closest point per `@/lib/corpus/closest-point`, the heading names that
