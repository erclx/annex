...
The numbered corpus itself is smaller after `feature-cut-provisions-at-headings`: 570 539 characters on the original and 384 799 on the consolidated, assembled the same way `FullContextArm._block` always has, over the same 306 and 133 stuffed provisions. The prompt-token row is left as recorded, for the reason the row above gives. Measured at this branch on 2026-09-14.
