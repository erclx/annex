---
name: operator-pass
description: Why a multi-finding inspection pass with the operator needs its own surface beside draft-and-pick, and where the boundary against building and auditing falls
---

# Operator pass requirement

## Gap

Without this skill, a session running an inspection pass with the operator:
...
- Record conditions, findings with their measurements, picks with the arms they beat, evidence paths and build criteria in one pass file under `.canon/review/`.
