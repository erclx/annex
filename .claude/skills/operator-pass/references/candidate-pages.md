...
- Capture into the pass's own numbered evidence folder instead of `.canon/review/evidence/<slug>/`, per `${CLAUDE_SKILL_DIR}/references/record.md`.
...
- Keep `candidates.html` and never apply the winning arm. The pass records and a build applies.
